...
import { Mail, Lock, User, ArrowRight, ArrowLeft, KeyRound, AlertCircle, Check, Eye, EyeOff, Sparkles } from "lucide-react";
...
const LoginPage = () => {
  ...
  if (isForgot) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative z-10 w-full max-w-md mx-4 bg-white border border-border shadow-2xl shadow-brand/5 rounded-3xl p-6 sm:p-8 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-10 rounded-xl bg-surface-2 p-5 border border-border flex gap-4 text-left">
                ...
                <p className="text-sm font-medium text-muted-foreground/80 leading-relaxed">
                  For security reasons, this link will expire in 1 hour. If you don't have access to this email, please contact our support team.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 text-center space-y-6">
            <p className="font-medium text-muted-foreground">
              ...
              <button onClick={() => { setIsForgot(false); setIsSignUp(true); }} className="text-brand font-black hover:underline">
                Sign up for free
              </button>
            </p>
  ...
  // ─── MAIN POPUP MODAL LAYOUT (Login / Register) ───
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" />
      ...
      {/* LEFT PANE (Brand Presence) - Hidden on Mobile */}
      <div className="hidden lg:flex w-full bg-brand text-white relative overflow-hidden flex-col justify-between p-8">
        ...
        <div className="relative z-10 w-full max-w-md mt-8 mb-auto">
          ...
          {/* Social Proof Overlaid Image Box */}
          <div className="relative h-[300px] w-full rounded-2xl overflow-hidden border-4 border-white/10 shadow-2xl">
            <img 
            ...
            {/* Social Proof Widget inside image */}
            <div className="absolute bottom-6 left-6 right-6">
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  {['22', '33', '44', '55'].map((id) => (
                    <img key={id} src={`https://i.pravatar.cc/100?img=${id}`} className="h-10 w-10 rounded-full border-2 border-white object-cover shadow-sm" alt="avatar" />
                  ))}
                  <div className="h-10 w-10 rounded-full border-2 border-white bg-[#0F1724] flex items-center justify-center text-xs font-black text-accent-yellow">
                    +2k
                  </div>
                </div>
              </div>
              <p className="mt-3 text-sm font-bold text-white/90">
                Join 2,000+ local businesses growing with us.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md mx-auto px-4 sm:px-8 py-6">
          ...
          <div className="space-y-6">
            ...
            <div className="relative flex items-center py-2">
              ...
              <span className="flex-shrink-0 mx-4 text-xs font-black uppercase text-muted-foreground/50 tracking-wider">
