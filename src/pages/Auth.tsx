    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center items-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-6 max-w-md">
          <div className="h-16 w-16 rounded-2xl bg-primary flex items-center justify-center mx-auto animate-glow-pulse">
            <Zap className="h-8 w-8 text-primary-foreground" />
          </div>
          <h1 className="text-4xl font-bold tracking-tight">ReviewFlow AI</h1>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Intercept bad reviews. Amplify great ones. Let AI handle your Google Business Profile responses.
          </p>
          <div className="flex gap-3 justify-center pt-4">
            {["Smart Filtering", "AI Responses", "QR Codes"].map((tag) => (
              <span key={tag} className="glass rounded-full px-4 py-1.5 text-xs font-medium">
                {tag}
              </span>
            ))}
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="glass-strong rounded-2xl p-8 glow-sm space-y-6">
